<template>
    <div class="sphere-animation">
        <svg class="sphere" viewBox="0 0 440 440" stroke="rgba(80,80,80,.5)">
            <defs>
    ...
    methods: {
        setSphereAnimation() {
            ...
            (function () {
                ...
                let spherePathEls = sphereEl.querySelectorAll("path");
